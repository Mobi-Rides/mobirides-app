...
-- Create secure database function for conversation creation with guaranteed authentication context
...
BEGIN
  ...
  RAISE LOG 'create_conversation_secure: Creating conversation for user %', v_user_id;
...
GRANT EXECUTE ON FUNCTION public.create_conversation_secure(text, text, uuid[], uuid) TO authenticated;
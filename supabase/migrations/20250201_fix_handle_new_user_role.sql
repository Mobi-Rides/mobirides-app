-- Fix handle_new_user function to include default role for new users
-- This ensures the trigger insert succeeds by setting role = 'renter' for new signups
...
BEGIN
    ...
    -- Insert into profiles with extracted data and default role
    INSERT INTO public.profiles (
        ...
        NEW.id,
        'renter',  -- Default role for new users
        user_full_name,
        user_phone_number,
    ...
    RAISE LOG 'handle_new_user: Successfully created profile for user % with role renter', NEW.id;

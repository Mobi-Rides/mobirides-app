...
drop policy "promo_code_cars_admin_policy" on "public"."promo_code_cars";

drop policy "promo_code_cars_select_policy" on "public"."promo_code_cars";
...
drop policy "super_admin_view_broadcast_logs" on "public"."system_broadcast_logs";

drop policy "super_admin_manage_broadcasts" on "public"."system_broadcasts";
...
revoke delete on table "public"."promo_code_cars" from "anon";

revoke insert on table "public"."promo_code_cars" from "anon";

revoke references on table "public"."promo_code_cars" from "anon";

revoke select on table "public"."promo_code_cars" from "anon";

revoke trigger on table "public"."promo_code_cars" from "anon";

revoke truncate on table "public"."promo_code_cars" from "anon";

revoke update on table "public"."promo_code_cars" from "anon";

revoke delete on table "public"."promo_code_cars" from "authenticated";

revoke insert on table "public"."promo_code_cars" from "authenticated";

revoke references on table "public"."promo_code_cars" from "authenticated";

revoke select on table "public"."promo_code_cars" from "authenticated";

revoke trigger on table "public"."promo_code_cars" from "authenticated";

revoke truncate on table "public"."promo_code_cars" from "authenticated";

revoke update on table "public"."promo_code_cars" from "authenticated";

revoke delete on table "public"."promo_code_cars" from "service_role";

revoke insert on table "public"."promo_code_cars" from "service_role";

revoke references on table "public"."promo_code_cars" from "service_role";

revoke select on table "public"."promo_code_cars" from "service_role";

revoke trigger on table "public"."promo_code_cars" from "service_role";

revoke truncate on table "public"."promo_code_cars" from "service_role";

revoke update on table "public"."promo_code_cars" from "service_role";

alter table "public"."promo_code_cars" drop constraint "promo_code_cars_car_id_fkey";

alter table "public"."promo_code_cars" drop constraint "promo_code_cars_promo_code_id_car_id_key";

alter table "public"."promo_code_cars" drop constraint "promo_code_cars_promo_code_id_fkey";

alter table "public"."promo_codes" drop constraint "promo_codes_host_id_fkey";
...
alter table "public"."system_broadcast_logs" drop constraint "system_broadcast_logs_broadcast_id_fkey";
...
drop index if exists "public"."idx_promo_code_cars_car_id";

drop index if exists "public"."idx_promo_code_cars_promo_id";

drop index if exists "public"."promo_code_cars_pkey";

drop index if exists "public"."promo_code_cars_promo_code_id_car_id_key";

drop table "public"."promo_code_cars";
...
alter table "public"."promo_codes" drop column "host_id";
...
with check (((role = ( SELECT profiles_1.role
  ...
  WHERE (profiles_1.id = auth.uid()))) OR public.is_admin(auth.uid())));
...
CREATE TRIGGER on_user_role_change AFTER INSERT OR DELETE OR UPDATE ON public.user_roles FOR EACH ROW EXECUTE FUNCTION public.handle_user_role_sync();

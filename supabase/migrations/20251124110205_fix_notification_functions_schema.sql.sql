-- Phase 2: Fix notification functions to use proper schema (title/description instead of content)
-- Recovered from archived migration 20250819083127

-- Drop and recreate create_booking_notification function
...
-- Update create_wallet_notification function

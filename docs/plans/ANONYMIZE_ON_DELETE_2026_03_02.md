...
**Status:** ✅ Complete — All phases verified and shipped.  
**Priority:** P1 — Data Integrity / Business Analytics Preservation  
**Owner:** Engineering

### Status Summary (as of April 17, 2026)
...
| Phase 3 — Frontend Guards | Admin table filter for soft-deleted users | ✅ Done |
| Phase 4 — RLS Policies | `is_deleted = false` filter on `profiles` SELECT policies | ✅ Done |
| Phase 5 — Testing | E2E test cases (MOB-137) | ✅ Complete |
| Phase 6 — Documentation | Update `INSURANCE_README.md`, knowledge base | ✅ Complete |  

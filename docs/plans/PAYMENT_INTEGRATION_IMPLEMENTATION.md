...
> **MOB-128 / AUD-004 payment label:** This is the target technical architecture. In the Sprint 14 production codebase, provider calls are **Mock/Pending**: PayGate/Ooze/DPO are planned or scaffolded but not live for real-money collection or payout.

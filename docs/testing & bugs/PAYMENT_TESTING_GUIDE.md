...
> **Sprint 15 / AUD-004 status:** Payment processing is **Mock/Pending**. Use this guide for simulated booking payments, pending earnings, and withdrawal workflow checks only. Do not treat any step as live PayGate/Ooze/DPO money movement.

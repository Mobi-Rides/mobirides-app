...
import { Calendar as CalendarIcon, MapPin, ArrowUpDown, Filter } from "lucide-react";
...
export const SearchFilters = ({ onFiltersChange }: SearchFiltersProps) => {
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-80 [&>[data-radix-popper-close-button]]:hidden" align="start">

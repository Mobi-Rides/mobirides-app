  ...
  const reviewItems = [
    {
      ...
      completed: verificationData?.personalInfo?.fullName ? true : false,
      details: verificationData?.personalInfo?.fullName || "Not completed",
    },
    {
    ...
    },
    {
      ...
      completed: true,
      details: verificationData?.personalInfo?.phoneNumber || "Phone verified",
    },
    {

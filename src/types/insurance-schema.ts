...
export interface InsuranceClaim {
  ...
  location: string
  incident_location?: string // Alias for location to match dashboard usage
  police_report_filed: boolean
  police_report_number: string | null
  police_station: string | null
  estimated_damage_cost: number | null
  estimated_repair_cost?: number | null // Alias for estimated_damage_cost
  ...
  supporting_documents?: string[] // Alias for evidence_urls
...
export interface InsurancePolicy {
  ...
  premium_amount?: number // Alias for total_premium or calculated field

  ...
  public: {
    Tables: {
      ...
      system_broadcast_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "system_broadcast_logs_broadcast_id_fkey"
    ...
    Functions: {
      add_admin: {
        Args: { make_super_admin: boolean; target_user_id: string }
        Returns: undefined
      }
      ...
      bulk_suspend_users: {
        Args: { p_duration?: string; p_reason: string; p_user_ids: string[] }
        Returns: {
      ...
      is_conversation_participant:
        | { Args: { _conversation_id: string }; Returns: boolean }
        | {
            Args: { _conversation_id: string; _user_id: string }
            Returns: boolean
          }
      ...
      verify_bug010_fix: { Args: never; Returns: Json }
